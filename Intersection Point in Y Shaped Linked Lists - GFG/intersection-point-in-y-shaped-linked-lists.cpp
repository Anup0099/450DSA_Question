...
// given a two linkedlist we have to find the intersection point of two linkedlist samjha
// 3 - 6 - 9 - common next linkedlist is 10 - common then output is 15 - 30 - null output will be 15
